...
**Live Demo:** **Live Demo:** [armin-portfolioo.netlify.app](https://armin-portfolioo.netlify.app)
...
-   **Version Control:**
    -   [**Git & GitHub**](https://github.com/arminshami7/my-portfolio): For source code management.
...
1.  Clone the repo
    ```sh
    git clone https://github.com/arminshami7/my-portfolio
    ```
